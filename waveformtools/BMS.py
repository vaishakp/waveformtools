...
def compute_supertransl_alpha(supertrans_alpha_modes, theta, phi):
    ''' Compute the spherical Alpha supertranslation variable :math:`\\alpha(\\theta, \\phi)` given its modes. This method just multiplies the
        alpha modes with their corresponding spherical harmonic basis functions and returns the summed result.


    Parameters
    ----------

    supertrans_alpha_modes :    dict
    ...
    return supertransl_alpha_func



def boost_waveform(unboosted_waveform, conformal_factor, gridinfo):
